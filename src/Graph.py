...
class Graph:
    ...
    def do_lines_intersect(self, a1, a2, b1, b2):
        ...
        :param a1: (tuple) Starting node coordinates of the first line
        :param a2: (tuple) Ending node coordinates of the first line
        :param b1: (tuple) Starting node coordinates of the second line
        :param b2: (tuple) Ending node coordinates of the second line
